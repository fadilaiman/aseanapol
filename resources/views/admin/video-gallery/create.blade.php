...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('admin.video-gallery.store') }}" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 resize-none">{{ old('description') }}</textarea>
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Embed URL</label>
                <input type="url" name="embed_url" value="{{ old('embed_url') }}" placeholder="https://www.youtube.com/embed/VIDEO_ID"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500">
                <p class="text-xs text-gray-400 mt-1">Use the YouTube embed URL format: <code class="bg-gray-100 px-1 rounded">https://www.youtube.com/embed/VIDEO_ID</code></p>
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Local Video File Path</label>
                <input type="text" name="file_url" value="{{ old('file_url') }}" placeholder="media/videos/filename.mp4"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Thumbnail / Poster Image</label>
                <input type="text" name="thumbnail_url" value="{{ old('thumbnail_url') }}" placeholder="media/videos/posters/my-video.jpg or https://..."
                       class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500">
                <p class="text-xs text-gray-400 mt-1">Shown as the video's cover image before playback (fixes inconsistent auto-thumbnails across browsers). Relative path under <code class="bg-gray-100 px-1 rounded">public/</code>, or a full URL.</p>
            </div>
            ...
            <div>
                ...
                <input type="text" name="event_location" value="{{ old('event_location') }}" placeholder="City, Country"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500">
            </div>
            ...
            <div class="flex justify-end gap-3 pt-2 border-t border-gray-100">
                ...
                <button type="submit"
                        ...
                        style="background:#0a2540;">Save Video</button>
            </div>
        </form>
    </div>
</div>
